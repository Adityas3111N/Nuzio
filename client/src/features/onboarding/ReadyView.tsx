    ...
    <div className="flex-1 flex flex-col justify-between px-6 py-4 bg-[#09090f] overflow-y-auto no-scrollbar">
      <div>
        ...
        <div className="flex flex-col items-center text-center mt-2 mb-4">
          <div className="w-16 h-16 rounded-full bg-emerald-500/10 border-2 border-emerald-400/40 flex items-center justify-center shadow-xl shadow-emerald-500/20 mb-3">
            <CheckCircle2 className="w-8 h-8 text-emerald-400 stroke-[2.2]" />
          </div>

          <h2 className="text-2xl font-bold text-white tracking-tight">
            You're ready, {userPreferences.name || 'Aarav'}.
          </h2>
          <p className="text-xs text-slate-400 mt-1 max-w-[260px] leading-relaxed">
            Your first brief will be ready tomorrow at {userPreferences.scheduledTime}{' '}
            {userPreferences.scheduledPeriod}. We've also created a preview.
          </p>
        </div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2.5">
                ...
                <span className="text-xs text-slate-200 font-medium">
                  6 stories — ~{userPreferences.briefLengthMinutes} min
                </span>
              </div>
              <Check className="w-3.5 h-3.5 text-emerald-400 stroke-[3]" />
            </div>
      ...
      <div className="pt-6">
        <button
          ...
          className="w-full py-3.5 rounded-2xl bg-gradient-to-r from-[#06b6d4] via-[#6366f1] to-[#8b5cf6] text-white font-semibold text-sm shadow-xl shadow-cyan-500/20 active:scale-[0.98] transition-transform"
        >
          Start listening →
        </button>
      </div>
